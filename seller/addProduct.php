          ...
          <div class="well">
            ...
            <form method="post">
              ...
              <div class="form-group">
                ...
                <input type="weight" class="form-control" id="pwd" placeholder="Enter weight" name="weight">
              </div>
              <div class="form-group">
            ...
            <?php
              ...
              if(isset($_POST['add'])){
                ...
                $query = "INSERT INTO products (name, size, weight, buying_price) VALUES('$pname', $size,$weight, $price)";
