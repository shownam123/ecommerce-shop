            ...
            <table class="table">
                ...
                ?>
                            ...
                            <tr>
                                ...
                                <a href="editProduct.php?id=<?php echo $r['id']?>"  type="button" class="btn btn-warning">Edit</a>
                               
                                <a href="deleteProduct.php?id=<?php echo $r['id']?>" type="button" class="btn btn-danger">Delete</a>
                                </td>
